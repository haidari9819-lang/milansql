...
<body>
<div class="header">
  <div class="logo">&#128449; MilanSQL v1.1.0 Dashboard</div>
  <div class="status-bar">
    <span id="sv">v1.1.0</span>
...
async function loadSidebar(){
  try{
    ...
    if(std.status){const s=std.status;document.getElementById('sv').textContent=s.version||'v1.1.0';document.getElementById('su').textContent=s.uptime;document.getElementById('st').textContent=s.tableCount;document.getElementById('sp').textContent=s.port||'8080';}
