...
static void testGroup68() {
    ...
    check(engine.evalFuncPublic("VERSION", {}) == "MilanSQL v9.5.0",
          "version() returns MilanSQL v9.5.0");
...
static void testGroup72() {
    ...
    {
        milansql::Engine eng;
        check(eng.evalFuncPublic("VERSION", {}) == "MilanSQL v9.5.0",
              "Isolation #15: version() returns MilanSQL v9.5.0");
    }
}
...
// testGroup74: v9.5.0 — INSERT quoted VALUES with spaces + umlauts
// ============================================================
